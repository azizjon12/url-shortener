...
import (
	...
	resp "github.com/azizjon12/url-shortener/internal/lib/api/response"
	"github.com/azizjon12/url-shortener/internal/lib/logger/sl"
	"github.com/azizjon12/url-shortener/internal/lib/random"
...
func New(log *slog.Logger, urlSaver URLSaver) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err := validator.New().Struct(req); err != nil {
			// change error type to validator error
